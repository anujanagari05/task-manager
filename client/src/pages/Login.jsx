...
import { Mail, Lock, CheckSquare, ArrowRight, Sun, Moon, AlertTriangle } from 'lucide-react';

const Login = ({ onSwitchToRegister, isDarkMode, setIsDarkMode }) => {
      ...
      <div className="w-full max-w-md glass-panel p-8 md:p-10 rounded-[32px] border border-slate-200 dark:border-slate-850 animate-slide glow-accent relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {(error || validationError) && (
            <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-600 dark:text-rose-450 text-xs font-semibold flex items-center space-x-2">
